public class ShippingCostCalculator {
    double cost(Shipment s){
        ...
        if (s.type == ShipmentType.STANDARD) return 50 + 5*s.weightKg;
        if (s.type == ShipmentType.EXPRESS)  return 80 + 8*s.weightKg;
        if (s.type == ShipmentType.OVERNIGHT)return 120 + 10*s.weightKg;
